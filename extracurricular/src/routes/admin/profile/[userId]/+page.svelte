...
<div class="flex flex-col min-h-screen bg-gray-50">
    <header class="grid grid-cols-3 items-center bg-white py-4 px-8 shadow-sm border-b border-gray-200">
        ...
        <div class="flex justify-end gap-2">
            <a href="/admin" class="rounded-full border border-gray-300 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Back</a>
                ...
                <div class="w-full md:w-2/3">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea
                            ...
                            class="w-full border border-gray-300 rounded-xl p-4 text-sm h-48 resize-none outline-none focus:ring-2 focus:ring-blue-500"
                        ></textarea>
                    </div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            {#each allInterests as interest}
                                <label class="group cursor-pointer">
                                    ...
                                    <span
                                        class="px-4 py-2 rounded-full border border-gray-300 text-sm block transition-all
